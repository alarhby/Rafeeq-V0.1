...
import { Car, Plus, Clock, CheckCircle, XCircle, ArrowRight } from 'lucide-react';
            ...
            <div className="flex-1">
              <div className="flex justify-between">
                ...
                <span className={`text-xs px-2 py-1 rounded-full font-bold flex items-center gap-1 ${
                  v.status === VehicleStatus.APPROVED ? 'bg-green-50 text-green-600' :
